...
export const metadata: Metadata = {
  title: {
    default: "Galerie Artă",
    template: "%s | Galerie Artă",
  },
  description: "Galerie de artă originală — tablouri în ulei și acrilice disponibile pentru achiziție.",
  openGraph: {
    siteName: "Galerie Artă",
    locale: "ro_RO",
  },
};
